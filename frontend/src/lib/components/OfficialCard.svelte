...
<a href="/officials/{official.id}" class="card group hover:shadow-lg transition-all duration-200">
  <div class="p-6">
    <div class="flex items-start gap-4">
      ...
      <div class="flex-1 min-w-0">
        <h3 class="font-semibold text-lg text-gray-900 group-hover:text-primary-600 transition-colors truncate">
          {official.fullName}
        </h3>
        ...
        <div class="mt-2 flex flex-wrap gap-2">
          <span class={statusColors[official.status] || 'badge-info'}>
            {official.status}
          </span>
  ...
  <!-- Bottom bar -->
  <div class="px-6 py-3 bg-gray-50 border-t border-gray-100 group-hover:bg-primary-50 transition-colors">

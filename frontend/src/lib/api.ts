...
// Victims
export async function getVictims(params: {
  page?: number;
  limit?: number;
  search?: string;
  category?: string;
...
// Political Prisoners
export async function getPrisoners(params: {
  page?: number;
  limit?: number;
  search?: string;
  status?: string;
  ...
  if (params.torture !== undefined) searchParams.set('torture', params.torture.toString());
  if (params.currentlyDetained !== undefined) searchParams.set('currentlyDetained', params.currentlyDetained.toString());
...
// Exile Stories
export async function getExileStories(params: {
  page?: number;
  limit?: number;
  search?: string;
  reason?: string;
  ...
  if (params.journeyRoute) searchParams.set('journeyRoute', params.journeyRoute);

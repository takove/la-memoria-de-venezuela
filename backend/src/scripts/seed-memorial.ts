...
async function upsertPrisoner(
  dataSource: DataSource,
  payload: Partial<PoliticalPrisoner>,
) {
...
async function upsertExileStory(
  dataSource: DataSource,
  payload: Partial<ExileStory>,
) {
  ...
  const existing = uniqueKey
    ? await repo.findOne({
        where: [{ displayName: uniqueKey }, { fullName: uniqueKey }],
      })
    : null;
  if (existing) {
    return repo.save({ ...existing, ...payload });
  ...
  const victims: Partial<Victim>[] = [
    {
      ...
      circumstanceEs:
        "Impactado en el pecho por una granada de gas lacrimógeno disparada a quemarropa durante protesta.",
      biographyEs:
        "Estudiante de la Universidad Metropolitana, jugador de baloncesto.",
    ...
    },
    {
      ...
      circumstanceEs:
        "Murió por impacto de explosivo durante enfrentamientos con fuerzas de seguridad en protesta.",
      biographyEs:
        "Joven manifestante de 17 años que participaba activamente en las protestas de 2017.",
      confidenceLevel: ConfidenceLevel.MULTIPLE_REPORTS,
      evidenceSources: [
        {
          type: "news_article",
      ...
      evidenceSources: [
        {
          type: "news",
          title:
            "RSF: Venezuelan journalist completes 12 months of arbitrary detention",
  ...
  const exiles: Partial<ExileStory>[] = [
    {
      ...
      journeyDescriptionEs:
        "Cruzó la selva del Darién en 10 días con su familia, enfrentando ríos y extorsión.",
      ...
      careerLost: true,
      careerDescription:
        "Dejó trabajo informal en Caracas; busca empleo estable.",
      storyEs:
        "“No había medicinas para mi hijo. Preferimos arriesgarnos en la selva que quedarnos sin nada.”",
      messageToVenezuelaEs:
        "Resistamos y documentemos, para que el mundo sepa lo que vivimos.",
      confidenceLevel: 3,
      evidenceSources: [
        {
          type: "organization",
          description:
            "Reuters: Venezuelans now majority of Darien Gap crossings (Sept 2023)",
    ...
    },
    {
      ...
      journeyRoute: JourneyRoute.DARIEN_GAP,
      journeyDescriptionEs:
        "Cruzaron el Darién en 7 días guiados por coyotes; presenciaron muertes en la ruta.",
      ...
      careerLost: true,
      careerDescription:
        "Padre era técnico electricista; madre trabajaba en comercio informal.",
      storyEs:
        "“Vimos niños arrastrados por el río. No hay vuelta atrás cuando entras al Darién.”",
      messageToVenezuelaEs:
        "Que se sepa lo que le hacen a nuestro pueblo: obligarnos a huir.",
      confidenceLevel: 3,
      evidenceSources: [
        {
          type: "organization",
          description:
            "AP: Migrants risk Darién Gap as Venezuelan exodus continues (2024 feature)",
